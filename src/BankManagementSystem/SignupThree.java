...
public class SignupThree extends JFrame implements ActionListener{
  ...
  SignupThree(String formno){
    ...
    JLabel pinDetails = new JLabel("Your 4 Digit Passwords");
  ...
  public void actionPerformed(ActionEvent ae){
    if(ae.getSource() == submit){
      ...
      String fascility = "";
      if(c1.isSelected()){
        fascility = fascility + " ATM Card";
      }else if (c2.isSelected()){
        fascility = fascility + " Internet Banking";
      }else if(c3.isSelected()){
        fascility = fascility + " Mobile Banking";
      }else if(c4.isSelected()){
        fascility = fascility + " EMAIL & SMS Alerts";
      }else if(c5.isSelected()){
        fascility = fascility + " Cheque Book";
      }else if(c6.isSelected()){
        fascility = fascility + " E-Statement";
      }
      ...
      try{
        if(accountType.equals("")){
          ...
          conn c = new conn();
          String query1 = "INSERT INTO signupthree VALUES('" + formno + "','" + accountType + "', '" + cardnumber + "', '" + pinnumber + "','" + fascility + "')";
